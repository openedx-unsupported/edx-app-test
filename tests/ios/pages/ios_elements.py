...
profile_options_personal_information_profile_view = 'PersonalInformationCell:profile-image-view'
...
dates_calendar_sync_message = 'CourseDatesHeaderView:label-sync-message'
dates_calendar_sync_toggle = 'CourseDatesHeaderView:switch-toggle-calendar-sync'
calendar_permission_popup_dont_allow_button = 'Don’t Allow'
calendar_permission_popup_allow_button = 'OK'
calendar_add_permission_cancel_button = 'Cancel'
calendar_add_permission_add_button = 'Add'
calendar_add_permission_done_button = 'Done'
calendar_add_permission_view_events_button = 'View Events'
calendar_remove_permission_remove_button = 'Remove'
