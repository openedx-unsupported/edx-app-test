...
course_dashboard_course_header_outline = 'CourseOutlineHeaderView:message-label'
course_dashboard_course_header_subtitle = 'CourseOutlineHeaderView:subtitle-label'
