...
PROFILE_OPTIONS_SIGNOUT_VERSION_ANDROID = 'Version 3.1.4 '
...
CREATE_POST_TOPIC_SPINNER_TEXT = 'Topic: Course Q&A'
...
ADD_CALENDAR_ALERT_TITLE_IOS = 'Add calendar "edX - DemoX"'
CALENDAR_EVENTS_ALERT_TITLE_IOS = '"edX - DemoX" has been added to your calendar.'
REMOVE_CALENDAR_EVENTS_TITLE_IOS = 'Remove calendar "edX - DemoX"'
REMOVE_CALENDAR_EVENTS_MESSAGE_IOS = 'Would you like to remove the edX calendar "edX - DemoX" ?'
