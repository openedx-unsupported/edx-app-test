...
PROFILE_OPTIONS_SIGNOUT_VERSION_ANDROID = 'Version 4.0.2 PROD TEST'
...
DISCUSSION_DETAILS_POST_DEFAULT_GROUP_TEXT = 'This post is visible only to Default Group.'
