...
LOGIN_USER_NAME_WATER_MARK_ANDROID = 'Username or email'
...
REGISTER_SHOW_OPTIONAL_FIELDS_OPTION = 'Optional fields'
REGISTER_HIDE_OPTIONAL_FIELDS_OPTION = 'Hide optional fields'
REGISTER_CREATE_MY_ACCOUNT = 'Create an account'
...
REGISTER_CHECKBOX = 'I agree that edX may send me marketing messages.'
